...
<body>
    ...
    <form action="login.php" method="post">
            ...
            <div class="forgot">
                <a href="https://sistemasenoferta.blogspot.com/search/label/Sistemas%20VIP"  >Catalogo de sisemas aqui</a>
                <p><input type="checkbox">Recordar password</p>
            </div>
            <button type="submit" name="login">Login</button>
        </form>
        <p class=" w3l-register-p">Cotiza tu desarrollo web por chat aqui?<a href="https://www.facebook.com/sistemasenoferta/" class="register" target="_blank">  aqui</a></p>
    </div>
    <footer>
